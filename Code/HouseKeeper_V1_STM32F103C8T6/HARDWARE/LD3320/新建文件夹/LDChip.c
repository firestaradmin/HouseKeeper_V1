...
//sbit RSTB=P3^3;
//sbit CSB=P2^6;
#define ICR_INT_Pin GPIO_Pin_8	//PA8
#define ICR_RST_Pin GPIO_Pin_11	//PA11
#define ICR_CSB_Pin GPIO_Pin_4	//PA4
#define RSTB 	PAout(11)
#define CSB		PAout(4)
...
void LD_GPIO_init()
{
	...
	/* INT的IO口设置 */
	GPIO_InitStructure.GPIO_Pin = ICR_INT_Pin ;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;		
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOA, &GPIO_InitStructure);
	
	/* RST的IO口设置 */
	GPIO_InitStructure.GPIO_Pin = ICR_RST_Pin ;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;		
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOA, &GPIO_InitStructure);
